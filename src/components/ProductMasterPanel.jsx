...
function ProductMasterPanel({ products, setProducts, categories, token }) {
  ...
  return <div className="crm-content-inner product-master-page">
    <div className="section-heading"><div><h1>Product Master</h1><p>Maintain the product catalogue used across the CRM.</p></div><button className="primary-action" type="button" onClick={openCreate}><Plus size={17} />Add product</button></div>
